...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-09-2023 a las 04:49:53
...
(1, 1, 25250, '2023-01-05 00:00:00'),
(2, 1, 25250, '2023-01-07 00:00:00'),
(3, 2, 92500, '2023-02-09 00:00:00'),
(4, 2, 92500, '2023-02-18 00:00:00'),
(5, 3, 234000, '2023-03-04 00:00:00'),
(6, 3, 234000, '2023-03-05 00:00:00'),
(7, 4, 164500, '2023-04-03 00:00:00'),
(8, 4, 164500, '2023-04-07 00:00:00'),
(9, 5, 107500, '2023-04-04 00:00:00'),
(10, 5, 107500, '2023-04-08 00:00:00'),
(11, 6, 108500, '2023-04-19 00:00:00'),
(12, 6, 108500, '2023-04-21 00:00:00'),
(13, 7, 8500, '2023-04-07 00:00:00'),
(14, 7, 8500, '2023-04-10 00:00:00'),
(15, 8, 153000, '2023-05-06 00:00:00'),
(16, 8, 153000, '2023-05-09 00:00:00'),
(17, 9, 21000, '2023-05-12 00:00:00'),
(18, 9, 21000, '2023-05-15 00:00:00'),
(19, 10, 359500, '2023-06-05 00:00:00'),
(20, 10, 359500, '2023-06-05 00:00:00'),
(21, 11, 90000, '2023-06-07 00:00:00'),
(22, 11, 90000, '2023-06-09 00:00:00'),
(23, 12, 112000, '2023-06-12 00:00:00'),
(24, 12, 112000, '2023-06-17 00:00:00'),
(25, 13, 88500, '2023-07-19 00:00:00'),
(26, 13, 88500, '2023-07-19 00:00:00'),
(27, 14, 53200, '2023-07-24 00:00:00'),
(28, 14, 53200, '2023-07-27 00:00:00'),
(29, 15, 42000, '2023-07-27 00:00:00'),
(30, 15, 42000, '2023-07-28 00:00:00'),
(31, 16, 179000, '2023-07-29 00:00:00'),
(32, 16, 179000, '2023-07-29 00:00:00'),
(33, 17, 220500, '2023-08-04 00:00:00'),
(34, 17, 220500, '2023-08-06 00:00:00'),
(35, 18, 34000, '2023-08-25 00:00:00'),
(36, 18, 34000, '2023-08-26 00:00:00'),
(37, 19, 90000, '2023-08-28 00:00:00'),
(38, 19, 90000, '2023-08-28 00:00:00'),
(39, 20, 700000, '2023-08-31 00:00:00'),
(40, 20, 700000, '2023-08-31 00:00:00');
...
(1, 'ALCOHOL', 'ANTISÉPTICO 250ML', '5200', 50, 'Un antiséptico en formato líquido de 250 ml para desinfección y limpieza de superficies y manos.', 'img/alco.png', 100, 10),
(5, 'GEL ANTIBACTERIAL', 'ANTIBACTERIAL 220 ML', '7500', 30, 'Gel antibacterial en un envase de 220 ml, ideal para la higiene de manos y prevención de enfermedade', 'img/anti.png', 150, 20),
(6, 'KIT', 'KIT ALCOHOL 750 ML + GEL ANTIBACTERIAL 500ML', '28000', 40, 'Un kit que incluye una botella de alcohol de 750 ml y un gel antibacterial de 500 ml, perfecto para ', 'img/kit.png', 50, 20),
(8, 'JABÓN', 'JABÓN ANTIBACTERIAL 250 M', '4500', 10, 'Jabón antibacterial en formato líquido de 250 ml, diseñado para una limpieza efectiva y protección c', 'img/ja.png', 50, 10),
(9, 'HIPOCLORITO', 'HIPOCLORITO X 1000 ML', '20000', 50, 'Hipoclorito de sodio en una botella de 1000 ml, un desinfectante eficaz para la limpieza y desinfecc', 'img/hipo.png', 150, 20),
(11, 'GUANTESCAJA X 100 UNIDADES', 'GUANTES DE NITRILO', '47000', 60, 'Guantes de nitrilo en una caja de 100 unidades, proporcionan una barrera protectora para las manos e', 'img/guan.png', 100, 20),
(14, 'RESPIRADOR', 'N95 CON FILTRO', '9000', 30, 'Máscara respiratoria N95 con filtro, diseñada para filtrar partículas y ofrecer protección respirato', 'img/res.png', 100, 10),
(19, 'TAPABOCAS', 'TAPABOCAS NORMAL TELA ANTOFLUIDO & ANTIBACTERIAL', '17000', 70, 'Tapabocas de tela antifluido y antibacterial, brinda protección y comodidad para uso diario.', 'img/tapa.png', 150, 20),
(23, 'TRAJES (ANTIFLUIDOS Y BIOSEFURIDAD)', 'TRAJE DE BIOSEGURIDAD DESECHABLE', '42000', 70, 'Traje de bioseguridad desechable, ofrece protección completa en entornos donde se requiere control d', 'img/tra1.png', 150, 20),
(24, 'TRAJES (ANTIFLUIDOS Y BIOSEFURIDAD)', 'TRAJE DE BIOSEGURIDAD LAVABLE', '53000', 50, 'Traje de bioseguridad lavable, proporciona protección y puede reutilizarse después de la limpieza.', 'img/tra2.png', 100, 20),
(25, 'GAFAS DE PROTECCION PERSONAL', 'GAFAS DE PROTECCION PERSONAL', '12000', 20, 'Gafas de protección personal diseñadas para resguardar los ojos de partículas y salpicaduras.', 'img/ga.png', 50, 10),
(29, 'CARETASL', 'DE PROTECCION FACIAL VISERA', '17000', 10, 'Careta de protección facial con visera, brinda protección contra salpicaduras y gotas en el rostro.', 'img/ca.png', 50, 10),
(31, 'CASCO', 'CASCO CERTIFICADO ARMADURA TIPO 1 + 3 RESPUESTOS D', '45000', 30, 'Casco de seguridad certificado con visor en PET, ofrece protección en entornos industriales y de con', 'img/cas.png', 100, 20),
(32, 'SEÑALIZACIÓN', 'SEÑALIZACIÓN 30 CM X 15 CML', '6000', 40, 'Señalización de seguridad de 30 cm x 15 cm, utilizada para indicar advertencias o instrucciones en e', 'img/se.png', 50, 10),
(35, 'PUNTO ECOLOGICO', 'PUNTO ECOLOGICO', '200000', 20, 'Punto ecológico diseñado para la segregación de residuos y la promoción de prácticas sostenibles en ', 'img/eco.png', 30, 10);
