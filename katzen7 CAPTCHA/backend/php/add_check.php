<?php
   ...
   if($cart_total == 0){
      ...
      $insert_order = $connect->prepare("INSERT INTO `orders`(clien_numdoc, nomcl, method, total_products, total_price, placed_on,payment_status, tipc) VALUES(?,?,?,?,?,?, 'Aceptado', ?)");
      $insert_order->execute([$numdoc, $nomcl, $method,$total_products, $cart_total, $placed_on, $tipc]);
