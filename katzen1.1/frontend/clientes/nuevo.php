...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
  ...
  <strong>Importante!</strong> Es importante rellenar los campos con &nbsp;<span class="badge-warning">*</span>
    ...
    <label for="email"><b>Direcciòn</b></label><span class="badge-warning">*</span>
    <input type="text" placeholder="ejm: Av 30 " name="apecl"  required>

    <label for="email"><b>Teléfono de la empresa</b></label><span class="badge-warning">*</span>
