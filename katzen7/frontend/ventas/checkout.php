...
<body>
   ...
   ?>
   <p> <?= $fetch_cart_items['name']; ?> <span>(<?= 'COP/'.$fetch_cart_items['precio'].'/- x '. $fetch_cart_items['quantity']; ?>)</span> </p>
   <?php
    }
   }else{
   ...
   ?>
   <div class="grand-total">Precio Total : <span>COP/<?php echo number_format($cart_grand_total, 2); ?></span></div>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
  ...
  <strong>Importante!</strong> Es importante rellenar los campos con &nbsp;<span class="badge-warning">*</span>
    ...
    <label for="email"><b>Numero documento</b></label><span class="badge-warning">*</span>
