...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
  ...
  <strong>Importante!</strong> Es importante rellenar los campos con &nbsp;<span class="badge-warning">*</span>
    ...
    <label for="email"><b>Id usuario que lo esta ingresando</b></label><span class="badge-warning">*</span>
    <input type="text" maxlength="11" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" placeholder="ejm: 1" name="idusuario"  required>
  
    <label for="psw"><b>Tipo de documento de la empresa</b></label><span class="badge-warning">*</span>
    <select required name="tipcl">
        ...
        <option value="camara_de_comercio">Cámara de Comercio</option>
        <option value="certificado_existencia_representacion_legal">Certificado de Existencia y Representación Legal</option>
        <option value="licencias_permisos_especificos">Licencias y Permisos Específicos</option>
        <option value="registro_unico_de_proponentes">Registro Único de Proponentes (RUP)</option>
        <option value="seguridad_social_aportes_fondos_pensiones">Seguridad Social y Aportes a Fondos de Pensiones</option>
        <option value="cuentas_bancarias">Cuentas Bancarias</option>
        <option value="registros_contables_libros_contabilidad">Registros Contables y Libros de Contabilidad</option>
        <option value="certificados_cumplimiento_tributario">Certificados de Cumplimiento Tributario</option>
    </select>

    <label for="email"><b>Número del documento de la empresa</b></label><span class="badge-warning">*</span>
    ...
    <label for="email"><b>Teléfono</b></label><span class="badge-warning">*</span>
