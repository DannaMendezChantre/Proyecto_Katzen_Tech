<?php  
 ...
 if(isset($_POST['add_prodct']))
 {
  ...
  if(!isset($errMSG))
  {
   $stmt = $connect->prepare("INSERT INTO productos(codpro, nomprd,desprd,foto,precio,stock,idmar,idcate,state) VALUES(:codpro, :nomprd,:desprd,:foto,:precio,:stock,:idmar,:idcate, '1')");
